...
// Method to check if the cart is deleted
CartSchema.methods.isDeleted = function() {
...
// Static method to soft delete a cart
CartSchema.statics.softDelete = function(cartId) { 
    return this.findByIdAndUpdate(cartId, { deletedAt: Date.now() }, { new: true });
};
