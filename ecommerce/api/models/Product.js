...
// Method to check if the product is deleted
...
ProductSchema.statics.softDelete = function(productId) {
    return this.findByIdAndUpdate(productId, { deletedAt: Date.now() }, { new: true });
};

// Static method to restore a soft-deleted product
ProductSchema.statics.restore = function(productId) {
    return this.findByIdAndUpdate(productId, { deletedAt: null }, { new: true });
};
